...
> **Full documentation lives in the sibling skill:** `.claude/skills/agent-browser/`
...
|-----------------------------|--------|---------|
| playwright-cli | `.claude/skills/playwright-cli/` | You need test generation, tracing, video recording, or request mocking |
| Claude in Chrome | `claude --chrome` or `/chrome` | You need visual verification, styling checks, or to leverage login state |
