...
skills: moai-foundation-claude, moai-foundation-core, moai-lang-typescript, moai-lang-javascript, moai-domain-frontend, moai-foundation-quality
---
...
- moai-foundation-core -- Core orchestration and execution standards
...
Context Engineering: Load SPEC and manifest.json first. Fetch Chrome API documentation via Context7 on-demand after extension type detection.
