...
memory: user
skills: moai-foundation-claude, moai-foundation-core, moai-foundation-quality, moai-workflow-testing, moai-workflow-loop, moai-lang-python, moai-lang-typescript, moai-lang-javascript, moai-tool-ast-grep
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
