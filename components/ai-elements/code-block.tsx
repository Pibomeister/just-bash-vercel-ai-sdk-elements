...
const CodeBlockContext = createContext<CodeBlockContextType>({
	code: '',
	language: 'shellscript' as BundledLanguage,
})
...
export const CodeBlockContent = ({
	...
	useEffect(() => {
		...
		// eslint-disable-next-line react-hooks/set-state-in-effect -- intentional sync setState for cached results
...
export type CodeBlockExpandButtonProps = Omit<
			...
			<Dialog open={open} onOpenChange={setOpen}>
				<DialogPortal>
					...
					>
						...
						<div className="w-full max-w-5xl max-h-[90vh] flex flex-col overflow-hidden rounded-lg bg-background border">
