...
description: |
  Extract tribal knowledge from your codebase into concise, documented
  standards. Analyzes code patterns, asks the user about intent, and
  creates scannable standard files in agent-os/standards/. Follows a
  6-step interactive loop per standard.
---
...
3. Ask the user to pick an area:
...
3. Ask the user to select which findings to document:
