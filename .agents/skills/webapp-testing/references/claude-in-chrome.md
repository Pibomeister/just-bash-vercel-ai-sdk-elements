...
> **Note:** This feature is specific to Claude Code. Other AI coding agents should use Playwright CLI or agent-browser for browser automation.
...
| ------------------------------ | -------------------------------- | ---------------------------------------------- |
| playwright-cli                 | `.agents/skills/playwright-cli/` | You need automated, repeatable test scripts    |
| agent-browser                  | `.agents/skills/agent-browser/`  | You need headless automation or CI integration |
