...
[Permalink: React-PDF](https://www.npmjs.com/package/react-pdf?activeTab=versions#react-pdf)

Display PDFs in your React app as easily as if they were images.

## Lost?

[Permalink: Lost?](https://www.npmjs.com/package/react-pdf?activeTab=versions#lost)
...
[Permalink: tl;dr](https://www.npmjs.com/package/react-pdf?activeTab=versions#tldr)
...
- Import stylesheets for [annotations](https://www.npmjs.com/package/react-pdf?activeTab=versions#support-for-annotations) and [text layer](https://www.npmjs.com/package/react-pdf?activeTab=versions#support-for-text-layer) if applicable.

## Demo

[Permalink: Demo](https://www.npmjs.com/package/react-pdf?activeTab=versions#demo)
...
[Permalink: Before you continue](https://www.npmjs.com/package/react-pdf?activeTab=versions#before-you-continue)
...
[Permalink: Getting started](https://www.npmjs.com/package/react-pdf?activeTab=versions#getting-started)

### Compatibility

[Permalink: Compatibility](https://www.npmjs.com/package/react-pdf?activeTab=versions#compatibility)

#### Browser support

[Permalink: Browser support](https://www.npmjs.com/package/react-pdf?activeTab=versions#browser-support)
...
[Permalink: React](https://www.npmjs.com/package/react-pdf?activeTab=versions#react)

To use the latest version of React-PDF, your project needs to use React 16.8 or later.

#### Preact

[Permalink: Preact](https://www.npmjs.com/package/react-pdf?activeTab=versions#preact)

React-PDF may be used with Preact.

### Installation

[Permalink: Installation](https://www.npmjs.com/package/react-pdf?activeTab=versions#installation)

Add React-PDF to your project by executing `npm install react-pdf` or `yarn add react-pdf`.

#### Next.js

[Permalink: Next.js](https://www.npmjs.com/package/react-pdf?activeTab=versions#nextjs)
...
[Permalink: Configure PDF.js worker](https://www.npmjs.com/package/react-pdf?activeTab=versions#configure-pdfjs-worker)

For React-PDF to work, PDF.js worker needs to be provided. You have several options.

#### Import worker (recommended)

[Permalink: Import worker (recommended)](https://www.npmjs.com/package/react-pdf?activeTab=versions#import-worker-recommended)
...
[Permalink: Parcel 2](https://www.npmjs.com/package/react-pdf?activeTab=versions#parcel-2)
...
[Permalink: Copy worker to public directory](https://www.npmjs.com/package/react-pdf?activeTab=versions#copy-worker-to-public-directory)
...
[Permalink: Use external CDN](https://www.npmjs.com/package/react-pdf?activeTab=versions#use-external-cdn)
...
[Permalink: Usage](https://www.npmjs.com/package/react-pdf?activeTab=versions#usage)
...
[Permalink: Support for annotations](https://www.npmjs.com/package/react-pdf?activeTab=versions#support-for-annotations)
...
[Permalink: Support for text layer](https://www.npmjs.com/package/react-pdf?activeTab=versions#support-for-text-layer)
...
[Permalink: Support for non-latin characters](https://www.npmjs.com/package/react-pdf?activeTab=versions#support-for-non-latin-characters)
...
[Permalink: Copying cMaps](https://www.npmjs.com/package/react-pdf?activeTab=versions#copying-cmaps)
...
[Permalink: Vite](https://www.npmjs.com/package/react-pdf?activeTab=versions#vite)
...
[Permalink: Webpack](https://www.npmjs.com/package/react-pdf?activeTab=versions#webpack)
...
[Permalink: Other tools](https://www.npmjs.com/package/react-pdf?activeTab=versions#other-tools)
...
[Permalink: Setting up React-PDF](https://www.npmjs.com/package/react-pdf?activeTab=versions#setting-up-react-pdf)
...
[Permalink: Support for JPEG 2000](https://www.npmjs.com/package/react-pdf?activeTab=versions#support-for-jpeg-2000)
...
[Permalink: Copying wasm directory](https://www.npmjs.com/package/react-pdf?activeTab=versions#copying-wasm-directory)
...
[Permalink: Vite](https://www.npmjs.com/package/react-pdf?activeTab=versions#vite-1)
...
[Permalink: Webpack](https://www.npmjs.com/package/react-pdf?activeTab=versions#webpack-1)
...
[Permalink: Other tools](https://www.npmjs.com/package/react-pdf?activeTab=versions#other-tools-1)
...
[Permalink: Setting up React-PDF](https://www.npmjs.com/package/react-pdf?activeTab=versions#setting-up-react-pdf-1)
...
[Permalink: Support for standard fonts](https://www.npmjs.com/package/react-pdf?activeTab=versions#support-for-standard-fonts)
...
[Permalink: Copying fonts](https://www.npmjs.com/package/react-pdf?activeTab=versions#copying-fonts)
...
[Permalink: Vite](https://www.npmjs.com/package/react-pdf?activeTab=versions#vite-2)
...
[Permalink: Webpack](https://www.npmjs.com/package/react-pdf?activeTab=versions#webpack-2)
...
[Permalink: Other tools](https://www.npmjs.com/package/react-pdf?activeTab=versions#other-tools-2)
...
[Permalink: Setting up React-PDF](https://www.npmjs.com/package/react-pdf?activeTab=versions#setting-up-react-pdf-2)
...
[Permalink: User guide](https://www.npmjs.com/package/react-pdf?activeTab=versions#user-guide)

### Document

[Permalink: Document](https://www.npmjs.com/package/react-pdf?activeTab=versions#document)

Loads a document passed using `file` prop.

#### Props

[Permalink: Props](https://www.npmjs.com/package/react-pdf?activeTab=versions#props)
...
[Permalink: Page](https://www.npmjs.com/package/react-pdf?activeTab=versions#page)
...
[Permalink: Props](https://www.npmjs.com/package/react-pdf?activeTab=versions#props-1)
...
[Permalink: Outline](https://www.npmjs.com/package/react-pdf?activeTab=versions#outline)
...
[Permalink: Props](https://www.npmjs.com/package/react-pdf?activeTab=versions#props-2)
...
[Permalink: Thumbnail](https://www.npmjs.com/package/react-pdf?activeTab=versions#thumbnail)
...
[Permalink: Props](https://www.npmjs.com/package/react-pdf?activeTab=versions#props-3)
...
[Permalink: Useful links](https://www.npmjs.com/package/react-pdf?activeTab=versions#useful-links)

- [React-PDF Wiki](https://github.com/wojtekmaj/react-pdf/wiki/)

## License

[Permalink: License](https://www.npmjs.com/package/react-pdf?activeTab=versions#license)

The MIT License.

## Author

[Permalink: Author](https://www.npmjs.com/package/react-pdf?activeTab=versions#author)
...
[Permalink: Thank you](https://www.npmjs.com/package/react-pdf?activeTab=versions#thank-you)
...
[Permalink: Sponsors](https://www.npmjs.com/package/react-pdf?activeTab=versions#sponsors)
...
[Permalink: Backers](https://www.npmjs.com/package/react-pdf?activeTab=versions#backers)
...
[Permalink: Top Contributors](https://www.npmjs.com/package/react-pdf?activeTab=versions#top-contributors)
...
| --- | --- | --- |
| [10.3.0](https://www.npmjs.com/package/react-pdf/v/10.3.0) | 589,691 | latest |
...
| --- | --- | --- |
| [10.3.0](https://www.npmjs.com/package/react-pdf/v/10.3.0) | 589,691 | a month ago |
| [10.2.0](https://www.npmjs.com/package/react-pdf/v/10.2.0) | 249,908 | 4 months ago |
| [10.1.0](https://www.npmjs.com/package/react-pdf/v/10.1.0) | 132,253 | 6 months ago |
| [10.0.1](https://www.npmjs.com/package/react-pdf/v/10.0.1) | 88,401 | 8 months ago |
| [10.0.0](https://www.npmjs.com/package/react-pdf/v/10.0.0) | 1,894 | 8 months ago |
| [9.2.1](https://www.npmjs.com/package/react-pdf/v/9.2.1) | 844,505 | a year ago |
| [9.2.0](https://www.npmjs.com/package/react-pdf/v/9.2.0) | 9,581 | a year ago |
| [9.1.1](https://www.npmjs.com/package/react-pdf/v/9.1.1) | 163,634 | a year ago |
| [9.1.0](https://www.npmjs.com/package/react-pdf/v/9.1.0) | 119,537 | 2 years ago |
| [9.0.0](https://www.npmjs.com/package/react-pdf/v/9.0.0) | 81,041 | 2 years ago |
| [8.0.2](https://www.npmjs.com/package/react-pdf/v/8.0.2) | 79,816 | 2 years ago |
| [7.7.3](https://www.npmjs.com/package/react-pdf/v/7.7.3) | 207,277 | 2 years ago |
| [8.0.0](https://www.npmjs.com/package/react-pdf/v/8.0.0) | 593 | 2 years ago |
| [7.7.1](https://www.npmjs.com/package/react-pdf/v/7.7.1) | 12,736 | 2 years ago |
| [7.7.0](https://www.npmjs.com/package/react-pdf/v/7.7.0) | 10,381 | 2 years ago |
| [7.6.0](https://www.npmjs.com/package/react-pdf/v/7.6.0) | 2,122 | 2 years ago |
| [7.5.1](https://www.npmjs.com/package/react-pdf/v/7.5.1) | 3,312 | 2 years ago |
| [7.5.0](https://www.npmjs.com/package/react-pdf/v/7.5.0) | 10,244 | 2 years ago |
| [7.4.0](https://www.npmjs.com/package/react-pdf/v/7.4.0) | 2,388 | 2 years ago |
| [7.3.3](https://www.npmjs.com/package/react-pdf/v/7.3.3) | 5,268 | 3 years ago |
| [7.3.2](https://www.npmjs.com/package/react-pdf/v/7.3.2) | 7 | 3 years ago |
| [7.3.1](https://www.npmjs.com/package/react-pdf/v/7.3.1) | 6 | 3 years ago |
| [7.3.0](https://www.npmjs.com/package/react-pdf/v/7.3.0) | 126 | 3 years ago |
| [7.2.0](https://www.npmjs.com/package/react-pdf/v/7.2.0) | 1,140 | 3 years ago |
| [7.1.3](https://www.npmjs.com/package/react-pdf/v/7.1.3) | 404 | 3 years ago |
| [7.1.2](https://www.npmjs.com/package/react-pdf/v/7.1.2) | 2,704 | 3 years ago |
| [7.1.1](https://www.npmjs.com/package/react-pdf/v/7.1.1) | 54 | 3 years ago |
| [7.1.0](https://www.npmjs.com/package/react-pdf/v/7.1.0) | 5 | 3 years ago |
| [7.0.3](https://www.npmjs.com/package/react-pdf/v/7.0.3) | 81 | 3 years ago |
| [7.0.2](https://www.npmjs.com/package/react-pdf/v/7.0.2) | 10 | 3 years ago |
| [7.0.1](https://www.npmjs.com/package/react-pdf/v/7.0.1) | 310 | 3 years ago |
| [7.0.0](https://www.npmjs.com/package/react-pdf/v/7.0.0) | 364 | 3 years ago |
| [7.0.0-beta.4](https://www.npmjs.com/package/react-pdf/v/7.0.0-beta.4) | 140 | 3 years ago |
| [7.0.0-beta.3](https://www.npmjs.com/package/react-pdf/v/7.0.0-beta.3) | 0 | 3 years ago |
| [7.0.0-beta.2](https://www.npmjs.com/package/react-pdf/v/7.0.0-beta.2) | 0 | 3 years ago |
| [7.0.0-beta](https://www.npmjs.com/package/react-pdf/v/7.0.0-beta) | 0 | 3 years ago |
| [6.2.2](https://www.npmjs.com/package/react-pdf/v/6.2.2) | 46,417 | 3 years ago |
| [6.2.1](https://www.npmjs.com/package/react-pdf/v/6.2.1) | 279 | 3 years ago |
| [6.2.0](https://www.npmjs.com/package/react-pdf/v/6.2.0) | 1,717 | 3 years ago |
| [6.1.1](https://www.npmjs.com/package/react-pdf/v/6.1.1) | 8 | 3 years ago |
| [6.1.0](https://www.npmjs.com/package/react-pdf/v/6.1.0) | 411 | 3 years ago |
| [6.0.3](https://www.npmjs.com/package/react-pdf/v/6.0.3) | 149 | 3 years ago |
| [6.0.2](https://www.npmjs.com/package/react-pdf/v/6.0.2) | 67 | 3 years ago |
| [6.0.1](https://www.npmjs.com/package/react-pdf/v/6.0.1) | 66 | 3 years ago |
| [6.0.0](https://www.npmjs.com/package/react-pdf/v/6.0.0) | 97 | 3 years ago |
| [6.0.0-beta.6](https://www.npmjs.com/package/react-pdf/v/6.0.0-beta.6) | 1 | 3 years ago |
| [6.0.0-beta.5](https://www.npmjs.com/package/react-pdf/v/6.0.0-beta.5) | 0 | 3 years ago |
| [6.0.0-beta.4](https://www.npmjs.com/package/react-pdf/v/6.0.0-beta.4) | 0 | 3 years ago |
| [6.0.0-beta.3](https://www.npmjs.com/package/react-pdf/v/6.0.0-beta.3) | 50 | 4 years ago |
| [6.0.0-beta.2](https://www.npmjs.com/package/react-pdf/v/6.0.0-beta.2) | 108 | 4 years ago |
| [6.0.0-beta](https://www.npmjs.com/package/react-pdf/v/6.0.0-beta) | 0 | 4 years ago |
| [5.7.2](https://www.npmjs.com/package/react-pdf/v/5.7.2) | 118,233 | 4 years ago |
| [5.7.1](https://www.npmjs.com/package/react-pdf/v/5.7.1) | 2,309 | 4 years ago |
| [5.7.0](https://www.npmjs.com/package/react-pdf/v/5.7.0) | 2,498 | 4 years ago |
| [5.6.0](https://www.npmjs.com/package/react-pdf/v/5.6.0) | 2,882 | 4 years ago |
| [5.5.0](https://www.npmjs.com/package/react-pdf/v/5.5.0) | 1,419 | 4 years ago |
| [5.4.1](https://www.npmjs.com/package/react-pdf/v/5.4.1) | 87 | 4 years ago |
| [5.4.0](https://www.npmjs.com/package/react-pdf/v/5.4.0) | 1,543 | 4 years ago |
| [5.4.0-beta.3](https://www.npmjs.com/package/react-pdf/v/5.4.0-beta.3) | 0 | 4 years ago |
| [5.4.0-beta.2](https://www.npmjs.com/package/react-pdf/v/5.4.0-beta.2) | 16 | 5 years ago |
| [5.3.2](https://www.npmjs.com/package/react-pdf/v/5.3.2) | 2,378 | 5 years ago |
| [5.4.0-beta](https://www.npmjs.com/package/react-pdf/v/5.4.0-beta) | 1 | 5 years ago |
| [5.3.1](https://www.npmjs.com/package/react-pdf/v/5.3.1) | 50 | 5 years ago |
| [5.3.0](https://www.npmjs.com/package/react-pdf/v/5.3.0) | 736 | 5 years ago |
| [5.3.0-beta.3](https://www.npmjs.com/package/react-pdf/v/5.3.0-beta.3) | 6 | 5 years ago |
| [5.3.0-beta.2](https://www.npmjs.com/package/react-pdf/v/5.3.0-beta.2) | 14 | 5 years ago |
| [5.3.0-beta](https://www.npmjs.com/package/react-pdf/v/5.3.0-beta) | 1 | 5 years ago |
| [5.2.0](https://www.npmjs.com/package/react-pdf/v/5.2.0) | 4,481 | 5 years ago |
| [5.1.0](https://www.npmjs.com/package/react-pdf/v/5.1.0) | 776 | 5 years ago |
| [5.1.0-beta](https://www.npmjs.com/package/react-pdf/v/5.1.0-beta) | 1 | 5 years ago |
| [5.0.0](https://www.npmjs.com/package/react-pdf/v/5.0.0) | 7,180 | 5 years ago |
| [5.0.0-beta.5](https://www.npmjs.com/package/react-pdf/v/5.0.0-beta.5) | 15 | 6 years ago |
| [4.2.0](https://www.npmjs.com/package/react-pdf/v/4.2.0) | 17,982 | 6 years ago |
| [5.0.0-beta.4](https://www.npmjs.com/package/react-pdf/v/5.0.0-beta.4) | 49 | 6 years ago |
| [5.0.0-beta.3](https://www.npmjs.com/package/react-pdf/v/5.0.0-beta.3) | 16 | 6 years ago |
| [5.0.0-beta.2](https://www.npmjs.com/package/react-pdf/v/5.0.0-beta.2) | 1 | 6 years ago |
| [5.0.0-beta](https://www.npmjs.com/package/react-pdf/v/5.0.0-beta) | 376 | 6 years ago |
| [4.2.0-beta](https://www.npmjs.com/package/react-pdf/v/4.2.0-beta) | 16 | 7 years ago |
| [4.1.0](https://www.npmjs.com/package/react-pdf/v/4.1.0) | 10,567 | 7 years ago |
| [4.0.5](https://www.npmjs.com/package/react-pdf/v/4.0.5) | 3,819 | 7 years ago |
| [4.0.4](https://www.npmjs.com/package/react-pdf/v/4.0.4) | 7 | 7 years ago |
| [4.0.3](https://www.npmjs.com/package/react-pdf/v/4.0.3) | 10 | 7 years ago |
| [4.0.2](https://www.npmjs.com/package/react-pdf/v/4.0.2) | 347 | 7 years ago |
| [4.0.0](https://www.npmjs.com/package/react-pdf/v/4.0.0) | 63 | 7 years ago |
| [3.0.6](https://www.npmjs.com/package/react-pdf/v/3.0.6) | 1,374 | 7 years ago |
| [4.0.0-beta.6](https://www.npmjs.com/package/react-pdf/v/4.0.0-beta.6) | 0 | 7 years ago |
| [4.0.0-beta.5](https://www.npmjs.com/package/react-pdf/v/4.0.0-beta.5) | 0 | 7 years ago |
| [4.0.0-beta.4](https://www.npmjs.com/package/react-pdf/v/4.0.0-beta.4) | 2 | 7 years ago |
| [4.0.0-beta.3](https://www.npmjs.com/package/react-pdf/v/4.0.0-beta.3) | 0 | 8 years ago |
| [4.0.0-beta.2](https://www.npmjs.com/package/react-pdf/v/4.0.0-beta.2) | 0 | 8 years ago |
| [4.0.0-beta](https://www.npmjs.com/package/react-pdf/v/4.0.0-beta) | 0 | 8 years ago |
| [3.0.5](https://www.npmjs.com/package/react-pdf/v/3.0.5) | 271 | 8 years ago |
| [3.0.4](https://www.npmjs.com/package/react-pdf/v/3.0.4) | 10 | 8 years ago |
| [3.0.3](https://www.npmjs.com/package/react-pdf/v/3.0.3) | 4 | 8 years ago |
| [3.0.2](https://www.npmjs.com/package/react-pdf/v/3.0.2) | 5 | 8 years ago |
| [3.0.1](https://www.npmjs.com/package/react-pdf/v/3.0.1) | 5 | 8 years ago |
| [3.0.0](https://www.npmjs.com/package/react-pdf/v/3.0.0) | 6 | 8 years ago |
| [3.0.0-beta](https://www.npmjs.com/package/react-pdf/v/3.0.0-beta) | 0 | 8 years ago |
| [3.0.0-alpha.4](https://www.npmjs.com/package/react-pdf/v/3.0.0-alpha.4) | 0 | 8 years ago |
| [2.5.3](https://www.npmjs.com/package/react-pdf/v/2.5.3) | 96 | 8 years ago |
| [3.0.0-alpha.3](https://www.npmjs.com/package/react-pdf/v/3.0.0-alpha.3) | 0 | 8 years ago |
| [3.0.0-alpha.2](https://www.npmjs.com/package/react-pdf/v/3.0.0-alpha.2) | 0 | 8 years ago |
| [3.0.0-alpha](https://www.npmjs.com/package/react-pdf/v/3.0.0-alpha) | 0 | 8 years ago |
| [2.5.2](https://www.npmjs.com/package/react-pdf/v/2.5.2) | 12 | 8 years ago |
| [2.5.1](https://www.npmjs.com/package/react-pdf/v/2.5.1) | 2 | 8 years ago |
| [2.5.0](https://www.npmjs.com/package/react-pdf/v/2.5.0) | 4 | 8 years ago |
| [2.4.2](https://www.npmjs.com/package/react-pdf/v/2.4.2) | 5 | 8 years ago |
| [2.4.1](https://www.npmjs.com/package/react-pdf/v/2.4.1) | 47 | 8 years ago |
| [2.4.0](https://www.npmjs.com/package/react-pdf/v/2.4.0) | 2 | 8 years ago |
| [2.3.0](https://www.npmjs.com/package/react-pdf/v/2.3.0) | 4 | 8 years ago |
| [2.2.0](https://www.npmjs.com/package/react-pdf/v/2.2.0) | 5 | 8 years ago |
| [2.1.7](https://www.npmjs.com/package/react-pdf/v/2.1.7) | 4 | 8 years ago |
| [2.2.0-beta.3](https://www.npmjs.com/package/react-pdf/v/2.2.0-beta.3) | 0 | 8 years ago |
| [2.2.0-beta.2](https://www.npmjs.com/package/react-pdf/v/2.2.0-beta.2) | 1 | 8 years ago |
| [2.2.0-beta](https://www.npmjs.com/package/react-pdf/v/2.2.0-beta) | 1 | 8 years ago |
| [2.1.6](https://www.npmjs.com/package/react-pdf/v/2.1.6) | 11 | 8 years ago |
| [2.1.5](https://www.npmjs.com/package/react-pdf/v/2.1.5) | 12 | 8 years ago |
| [2.1.4](https://www.npmjs.com/package/react-pdf/v/2.1.4) | 3 | 8 years ago |
| [2.1.3](https://www.npmjs.com/package/react-pdf/v/2.1.3) | 5 | 8 years ago |
| [2.1.1](https://www.npmjs.com/package/react-pdf/v/2.1.1) | 6 | 8 years ago |
| [2.1.0](https://www.npmjs.com/package/react-pdf/v/2.1.0) | 5 | 8 years ago |
| [2.0.0](https://www.npmjs.com/package/react-pdf/v/2.0.0) | 7 | 8 years ago |
| [2.0.0-beta.5](https://www.npmjs.com/package/react-pdf/v/2.0.0-beta.5) | 0 | 8 years ago |
| [2.0.0-beta.4](https://www.npmjs.com/package/react-pdf/v/2.0.0-beta.4) | 0 | 8 years ago |
| [2.0.0-beta.3](https://www.npmjs.com/package/react-pdf/v/2.0.0-beta.3) | 1 | 8 years ago |
| [2.0.0-beta.2](https://www.npmjs.com/package/react-pdf/v/2.0.0-beta.2) | 0 | 9 years ago |
| [2.0.0-beta](https://www.npmjs.com/package/react-pdf/v/2.0.0-beta) | 0 | 9 years ago |
| [2.0.0-alpha.7](https://www.npmjs.com/package/react-pdf/v/2.0.0-alpha.7) | 0 | 9 years ago |
| [2.0.0-alpha.5](https://www.npmjs.com/package/react-pdf/v/2.0.0-alpha.5) | 0 | 9 years ago |
| [2.0.0-alpha.4](https://www.npmjs.com/package/react-pdf/v/2.0.0-alpha.4) | 0 | 9 years ago |
| [2.0.0-alpha.3](https://www.npmjs.com/package/react-pdf/v/2.0.0-alpha.3) | 0 | 9 years ago |
| [2.0.0-alpha.2](https://www.npmjs.com/package/react-pdf/v/2.0.0-alpha.2) | 0 | 9 years ago |
| [2.0.0-alpha.1](https://www.npmjs.com/package/react-pdf/v/2.0.0-alpha.1) | 3 | 9 years ago |
| [2.0.0-alpha](https://www.npmjs.com/package/react-pdf/v/2.0.0-alpha) | 1 | 9 years ago |
| [1.8.3](https://www.npmjs.com/package/react-pdf/v/1.8.3) | 29 | 9 years ago |
| [1.8.2](https://www.npmjs.com/package/react-pdf/v/1.8.2) | 2 | 9 years ago |
| [1.8.1](https://www.npmjs.com/package/react-pdf/v/1.8.1) | 3 | 9 years ago |
| [1.8.0](https://www.npmjs.com/package/react-pdf/v/1.8.0) | 2 | 9 years ago |
| [1.7.0](https://www.npmjs.com/package/react-pdf/v/1.7.0) | 6 | 9 years ago |
| [1.6.1](https://www.npmjs.com/package/react-pdf/v/1.6.1) | 79 | 9 years ago |
| [1.6.0](https://www.npmjs.com/package/react-pdf/v/1.6.0) | 5 | 9 years ago |
| [0.0.10](https://www.npmjs.com/package/react-pdf/v/0.0.10) | 22 | 10 years ago |
| [0.0.9](https://www.npmjs.com/package/react-pdf/v/0.0.9) | 35 | 10 years ago |
| [0.0.8](https://www.npmjs.com/package/react-pdf/v/0.0.8) | 3 | 10 years ago |
| [0.0.7](https://www.npmjs.com/package/react-pdf/v/0.0.7) | 3 | 10 years ago |
| [0.0.6](https://www.npmjs.com/package/react-pdf/v/0.0.6) | 3 | 11 years ago |
| [0.0.5](https://www.npmjs.com/package/react-pdf/v/0.0.5) | 5 | 11 years ago |
| [0.0.4](https://www.npmjs.com/package/react-pdf/v/0.0.4) | 8 | 11 years ago |
| [0.0.3](https://www.npmjs.com/package/react-pdf/v/0.0.3) | 7 | 11 years ago |
| [0.0.2](https://www.npmjs.com/package/react-pdf/v/0.0.2) | 3 | 11 years ago |
| [0.0.1](https://www.npmjs.com/package/react-pdf/v/0.0.1) | 3 | 11 years ago |
