...
# mammoth  ![TypeScript icon, indicating that this package has built-in type declarations](https://static-production.npmjs.com/4a2a680dfcadf231172b78b1d3beb975.svg)

1.11.0 • Public • Published 5 months ago

- [Readme](https://www.npmjs.com/package/mammoth?activeTab=readme)
- [Code Beta](https://www.npmjs.com/package/mammoth?activeTab=code)
- [10 Dependencies](https://www.npmjs.com/package/mammoth?activeTab=dependencies)
- [731 Dependents](https://www.npmjs.com/package/mammoth?activeTab=dependents)
- [97 Versions](https://www.npmjs.com/package/mammoth?activeTab=versions)

# Mammoth .docx to HTML converter

[Permalink: Mammoth .docx to HTML converter](https://www.npmjs.com/package/mammoth#mammoth-docx-to-html-converter)
...
[Permalink: Web demo](https://www.npmjs.com/package/mammoth#web-demo)
...
[Permalink: Installation](https://www.npmjs.com/package/mammoth#installation)
...
[Permalink: Other supported platforms](https://www.npmjs.com/package/mammoth#other-supported-platforms)
...
Available [on Maven Central](http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22org.zwobble.mammoth%22%20AND%20a%3A%22mammoth%22).
...
[Permalink: Usage](https://www.npmjs.com/package/mammoth#usage)

### CLI

[Permalink: CLI](https://www.npmjs.com/package/mammoth#cli)
...
See the [Security](https://www.npmjs.com/package/mammoth#security) section for more information.

#### Images

[Permalink: Images](https://www.npmjs.com/package/mammoth#images)
...
[Permalink: Styles](https://www.npmjs.com/package/mammoth#styles)
...
A description of the syntax for style maps can be found in the section ["Writing style maps"](https://www.npmjs.com/package/mammoth#writing-style-maps).

#### Markdown

[Permalink: Markdown](https://www.npmjs.com/package/mammoth#markdown)
...
[Permalink: Library](https://www.npmjs.com/package/mammoth#library)
...
[Permalink: Basic conversion](https://www.npmjs.com/package/mammoth#basic-conversion)
...
[Permalink: Custom style map](https://www.npmjs.com/package/mammoth#custom-style-map)
...
[Permalink: Custom image handlers](https://www.npmjs.com/package/mammoth#custom-image-handlers)

By default, images are converted to `<img>` elements with the source included inline in the `src` attribute.
This behaviour can be changed by setting the `convertImage` option to an [image converter](https://www.npmjs.com/package/mammoth#image-converters) .
...
[Permalink: Bold](https://www.npmjs.com/package/mammoth#bold)
...
[Permalink: Italic](https://www.npmjs.com/package/mammoth#italic)
...
[Permalink: Underline](https://www.npmjs.com/package/mammoth#underline)
...
[Permalink: Strikethrough](https://www.npmjs.com/package/mammoth#strikethrough)
...
[Permalink: Comments](https://www.npmjs.com/package/mammoth#comments)
...
[Permalink: API](https://www.npmjs.com/package/mammoth#api)

#### `mammoth.convertToHtml(input, options)`

[Permalink: mammoth.convertToHtml(input, options)](https://www.npmjs.com/package/mammoth#mammothconverttohtmlinput-options)
...
May have the following properties:
  - `styleMap`: controls the mapping of Word styles to HTML.
    ...
    See ["Writing style maps"](https://www.npmjs.com/package/mammoth#writing-style-maps) for a reference to the syntax for style maps.
  ...
  - `convertImage`: by default, images are converted to `<img>` elements with the source included inline in the `src` attribute.
    Set this option to an [image converter](https://www.npmjs.com/package/mammoth#image-converters) to override the default behaviour.
  ...
  - `transformDocument`: if set,
    ...
    See [document transforms](https://www.npmjs.com/package/mammoth#document-transforms).
...
[Permalink: mammoth.convertToMarkdown(input, options)](https://www.npmjs.com/package/mammoth#mammothconverttomarkdowninput-options)
...
[Permalink: mammoth.extractRawText(input)](https://www.npmjs.com/package/mammoth#mammothextractrawtextinput)
...
[Permalink: mammoth.embedStyleMap(input, styleMap)](https://www.npmjs.com/package/mammoth#mammothembedstylemapinput-stylemap)
...
[Permalink: Messages](https://www.npmjs.com/package/mammoth#messages)
...
[Permalink: Image converters](https://www.npmjs.com/package/mammoth#image-converters)
...
[Permalink: Security](https://www.npmjs.com/package/mammoth#security)
...
[Permalink: Document transforms](https://www.npmjs.com/package/mammoth#document-transforms)
...
[Permalink: mammoth.transforms.paragraph(transformParagraph)](https://www.npmjs.com/package/mammoth#mammothtransformsparagraphtransformparagraph)
...
[Permalink: mammoth.transforms.run(transformRun)](https://www.npmjs.com/package/mammoth#mammothtransformsruntransformrun)
...
[Permalink: mammoth.transforms.getDescendants(element)](https://www.npmjs.com/package/mammoth#mammothtransformsgetdescendantselement)

Gets all descendants of an element.

#### `mammoth.transforms.getDescendantsOfType(element, type)`

[Permalink: mammoth.transforms.getDescendantsOfType(element, type)](https://www.npmjs.com/package/mammoth#mammothtransformsgetdescendantsoftypeelement-type)
...
[Permalink: Writing style maps](https://www.npmjs.com/package/mammoth#writing-style-maps)
...
[Permalink: Freshness](https://www.npmjs.com/package/mammoth#freshness)
...
[Permalink: Document element matchers](https://www.npmjs.com/package/mammoth#document-element-matchers)

#### Paragraphs, runs and tables

[Permalink: Paragraphs, runs and tables](https://www.npmjs.com/package/mammoth#paragraphs-runs-and-tables)
...
[Permalink: Bold](https://www.npmjs.com/package/mammoth#bold-1)
...
[Permalink: Italic](https://www.npmjs.com/package/mammoth#italic-1)
...
[Permalink: Underline](https://www.npmjs.com/package/mammoth#underline-1)
...
[Permalink: Strikethough](https://www.npmjs.com/package/mammoth#strikethough)
...
[Permalink: All caps](https://www.npmjs.com/package/mammoth#all-caps)
...
[Permalink: Small caps](https://www.npmjs.com/package/mammoth#small-caps)
...
[Permalink: Highlight](https://www.npmjs.com/package/mammoth#highlight)
...
[Permalink: Ignoring document elements](https://www.npmjs.com/package/mammoth#ignoring-document-elements)
...
[Permalink: HTML paths](https://www.npmjs.com/package/mammoth#html-paths)

#### Single elements

[Permalink: Single elements](https://www.npmjs.com/package/mammoth#single-elements)
...
[Permalink: Separators](https://www.npmjs.com/package/mammoth#separators)
...
[Permalink: Nested elements](https://www.npmjs.com/package/mammoth#nested-elements)
...
[Permalink: Upgrading to later versions](https://www.npmjs.com/package/mammoth#upgrading-to-later-versions)

### 1.0.0

[Permalink: 1.0.0](https://www.npmjs.com/package/mammoth#100)
...
[Permalink: 0.3.0](https://www.npmjs.com/package/mammoth#030)
...
[Permalink: Custom style maps](https://www.npmjs.com/package/mammoth#custom-style-maps)
...
[Permalink: Document transforms](https://www.npmjs.com/package/mammoth#document-transforms-1)
...
[Permalink: 0.2.0](https://www.npmjs.com/package/mammoth#020)

The function `mammoth.style()` was renamed to `mammoth.styleMapping()`.

## Acknowledgements

[Permalink: Acknowledgements](https://www.npmjs.com/package/mammoth#acknowledgements)
...
[Permalink: Donations](https://www.npmjs.com/package/mammoth#donations)
...
- [docx](https://www.npmjs.com/search?q=keywords:docx)
- [html](https://www.npmjs.com/search?q=keywords:html)
- [office](https://www.npmjs.com/search?q=keywords:office)
- [word](https://www.npmjs.com/search?q=keywords:word)
- [markdown](https://www.npmjs.com/search?q=keywords:markdown)
- [md](https://www.npmjs.com/search?q=keywords:md)

Viewing mammoth version 1.11.0