...
if [ -f "/Users/eduardopicazo/go/bin/moai" ]; then
	exec "/Users/eduardopicazo/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/eduardopicazo/.local/bin/moai" ]; then
	exec "/Users/eduardopicazo/.local/bin/moai" statusline < "$temp_file"
fi
